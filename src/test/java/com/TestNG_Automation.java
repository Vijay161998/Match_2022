...
public class TestNG_Automation extends Base_Class {
	...
	private void lanchUrl() throws Throwable {
	...
	private void logIn(@Optional("ruvijay1998@gmail.com") String username,@Optional("Sachine@0130") String password) throws Throwable {

		clickOnElement(pom.getSign().getSignin_Btn());
		wait(30,TimeUnit.SECONDS);

		inputValueElement(pom.getLogin().getEmail(),username);
	...
	private void woman_Dress_Seletion() {
	...
	private void dresses_Selection() {
